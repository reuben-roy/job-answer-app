...
Technical Skills
Languages & Core: AWS, Anthropic, Azure, CI/CD, Claude Code, D3.js, Docker, Fastify, Firebase, FullCalendar, Gemini, GitHub Actions, GitHub Copilot, Go, Google Cloud, Gradle, GraphQL, Java, JavaScript, Kotlin, LLMs, Lucide, MySQL, Next.js, Node.js, OAuth, OpenAI, OpenCV, PostgreSQL, Prisma, Python, RAG, REST, React, React Native, SQL, SQLite, Spring, Spring Boot, Swift, Tailwind CSS, Three.js, TypeScript, Vercel, Vite, WordPress
...
- Kali-Platform: The React Native mobile app for Kali — a fitness platform that treats physical progression like version control. Features a DAG-based progression system, muscle-specific fatigue tracking, local-first architecture with SQLite, and a custom training plan engine. [Tech: TypeScript]
- Kali: Landing page and waitlist for Kali — a fitness platform concept that gamifies physical progression. Built with Next.js and PostgreSQL backend. Showcases the product vision before the mobile app launch. [Tech: TypeScript]
- Side-Track: A React Native iOS weight-training app with a custom fatigue engine that models muscle-specific recovery. Uses SQLite for offline-first data and predictive polling to reduce cloud costs. Features Apple Health sync and a progressive overload calculator. [Tech: Go, LLMs, OAuth, RAG, REST, React, React Native, SQL]
- Clackinator: A macOS menu bar app that plays mechanical keyboard sound effects while you type — adding satisfying auditory feedback to any keyboard. Built with Swift, it is lightweight and unobtrusive, designed for developers who love mechanical keyboards. [Tech: Go, RAG, REST, Swift]
...
- Window-Extension: A Chrome extension that transforms your browser into an intelligent productivity co-pilot — connecting to Google Calendar, blocking distractions during focus sessions, and running an OpenClaw-powered AI agent for task management and summarization. [Tech: AWS, Fastify, FullCalendar, Go, Node.js, OAuth, PostgreSQL, Prisma]
